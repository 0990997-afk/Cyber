...
import { runSommelier, type SommelierInput } from "@/lib/sommelier";
import { TIER_ORDER, type WineTier } from "@/lib/wines";
...
export async function POST(req: Request) {
  ...
  const occasion =
    typeof body.occasion === "string" ? body.occasion.slice(0, 200) : undefined;
  const budget: "any" | WineTier =
    typeof body.budget === "string" && TIER_ORDER.includes(body.budget as WineTier)
      ? (body.budget as WineTier)
      : "any";
